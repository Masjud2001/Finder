...
function App() {
  ...
  const handleUndo = () => {
    if (userProfile.vipTier === "free") {
      triggerToast("Unlock Rewinds with SoulSync Gold!");
      ...
      {!isLoggedIn && (
        <div className="landing-container">
          ...
          <div className="landing-hero">
            <h1>Swipe Right®</h1>
            <p>SoulSync helps you build genuine connections based on compatibility, lifestyle preference, and meaningful conversations.</p>
          ...
          <div className="sidebar">
            ...
            {userProfile.vipTier === "gold" && (
              <div className="sidebar-promo" style={{ background: "var(--gold-gradient)" }} onClick={() => setShowPremiumModal(true)}>
                <div className="promo-title">
                  <Sparkles size={16} />
                  <span>SoulSync Gold Active</span>
                </div>
              </div>
            )}
            {userProfile.vipTier === "platinum" && (
              <div className="sidebar-promo is-vip" onClick={() => setShowPremiumModal(true)}>
                <div className="promo-title">
                  <Sparkles size={16} />
                  <span>SoulSync Platinum Active</span>
                </div>
              </div>
            )}
        ...
        <div className="modal-overlay" onClick={() => setShowLoginModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="login-modal-inner">
              <div className="login-modal-logo">❤️ SoulSync</div>
            ...
            <div style={{ padding: "30px 20px 20px" }}>
              ...
              <div className="premium-cards-grid">
                ...
                >
                  <div className="premium-logo-row">
                    <span className="premium-tier-name">SoulSync Gold</span>
                ...
                >
                  <div className="premium-logo-row">
                    <span className="premium-tier-name">SoulSync Platinum</span>
              ...
              {userProfile.vipTier !== "free" ? (
                ...
                <button className="btn-purchase" onClick={() => {
                  ...
                  triggerToast("Subscribed to SoulSync Gold! Gold perks active.");
